# Copilot / agent instructions for Compukter-Playground
...
repo: CertifiedBadIdeas/Compukter-Playground
project_number: 1
...
- First content line under the `# Title` MUST be `> Issue: [#N](https://github.com/CertifiedBadIdeas/Compukter-Playground/issues/N)`.
